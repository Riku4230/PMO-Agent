      ...
      {[
        {
          title: "プロジェクトキックオフ支援",
          label: "議事録から計画立案まで",
          action: "プロジェクトキックオフの議事録を解析して、プロジェクト計画を立案してください。",
        },
        {
          title: "ステークホルダー分析",
          label: "関係者を特定して役割を整理",
          action: "プロジェクトのステークホルダーを特定し、役割と責任を整理してください。",
        },
        {
          title: "リスク分析",
          label: "潜在リスクを洗い出し",
          action: "プロジェクトの潜在的なリスクを洗い出し、対応策を提案してください。",
        },
        {
          title: "アクションプラン作成",
          label: "具体的なタスクと期限を設定",
          action: "プロジェクトのアクションプランを作成し、具体的なタスクと期限を設定してください。",
        },
